...
/**
 * Class siteAdvancedparamsFieldModel
 */
class siteAdvancedparamsFieldModel extends waModel
{
    /**
     * @var string
     */
    protected $table = 'site_advancedparams_field';
    ...
    /**
     * siteAdvancedparamsFieldModel constructor.
     * @param null $type
     * @param bool $writable
     */
    public function __construct($type = null, $writable = false)
    {
        $this->field_values_model = new siteAdvancedparamsFieldValuesModel();
    ...
    public function getActionFields($action)
    {
        ...
        foreach ($action_params as $k=>$b) {
            if(siteAdvancedparamsPlugin::isBannedField($action, $k)) {
            ...
            foreach ($action_params as $k => $v) {
              ...
              /*  $data = array(
                ...
                if(!$this->save($data, $errors)) {
                    ...
                    siteAdvancedparamsPlugin::log(implode(',', $errors));
                }*/
            }
        }
        ...
        foreach ($fields as $k => $v)
        {
            ...
            if(siteAdvancedparamsPlugin::isSelectableType($fields[$k]['type'])) {
    ...
    public function getFieldById($id) {
        ...
        if($field) {
            ...
            if(siteAdvancedparamsPlugin::isSelectableType($field['type'])) {
    ...
    public function field_exists($name, $action = '') {
        ...
        } elseif(!empty($name) && siteAdvancedparamsPlugin::actionExists($action)) {
    ...
    public function save($data, &$errors) {
        ...
        if(!empty($field)) {
           ...
           if(!isset($data['type']) || !array_key_exists($data['type'], $field_types)) {
            ...
            if(siteAdvancedparamsPlugin::actionExists($data['action'])) {
    ...
    public function getFieldTypes() {
        return siteAdvancedparamsPlugin::getConfigParam(siteAdvancedparamsPlugin::CONFIG_FIELD_TYPES_KEY);
    }
}