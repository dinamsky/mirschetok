...
/**
 * Class siteAdvancedparamsParamFileModel
 */
class siteAdvancedparamsParamFileModel extends waModel
{
    /**
     * @var string
     */
    protected $table = 'site_advancedparams_param_file';
    /**
     * Тип экшена
     * @var null|string
     */
    ...
    /**
     * siteAdvancedparamsParamFileModel constructor.
    ...
    public function deleteByName($field_name) {
        ...
        foreach ($action_ids as $action) {
            $filesClass = new siteAdvancedparamsPluginFiles($this->action, $action['action_id']);
