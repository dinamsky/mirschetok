<?php
return array(
    'site_advancedparams_field' => array(
        ...
        ':keys' => array(
            'PRIMARY' => 'id',
            'UK_site_adp_fld_name_action' => array('name', 'action', 'unique' => 1),
            'IDX_site_adp_fld_action' => 'action',
        ),
    ),
    'site_advancedparams_field_values' => array(
        'id' => array('int', 11, 'unsigned' => 1, 'null' => 0, 'autoincrement' => 1),
        ...
        ':keys' => array(
            'PRIMARY' => 'id',
            'IDX_site_adp_fld_values_field_id' => 'field_id',
        ),
    ),
    'site_advancedparams_param_file' => array(
        'action' => array('varchar', 50, 'null' => 0),
        ...
        ':keys' => array(
            ...
            'UK_site_adp_par_file_act_act_id_name' => array('action_id', 'name', 'action', 'unique' => 1),
            'IDX_site_adp_par_file_action_action_id' => array('action', 'action_id'),
        ),
    ),
    'site_advancedparams_param_value' => array(
        'action' => array('varchar', 50, 'null' => 0),
        ...
        ':keys' => array(
            'PRIMARY' => array('action', 'action_id', 'name'),
            'UK_site_adp_par_value_act_act_id_name' => array('action', 'action_id', 'name', 'unique' => 1),
            'IDX_site_adp_par_value_act_act_id' => array('action', 'action_id'),
        ),
    ),
);
