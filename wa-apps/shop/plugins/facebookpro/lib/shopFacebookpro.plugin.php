 ...
 * @see http://tjo.biz/
 */
class shopFacebookproPlugin extends shopPlugin
{
    private $types;
    ...
    {
        $icon = shopHelper::getIcon($this->getPluginStaticUrl().'img/facebookpro.png');
        $html = <<<HTML
 <li data-action="export" data-plugin="facebookpro" title="Экспорт выбранных товаров в Facebook и Instagram">
    <a href="#">{$icon}Facebook и Instagram</a>
 </li>
HTML;
    ...
    {
        $path = wa()->getDataPath('plugins/facebookpro/'.$file, false, 'shop', true);
        //TODO: prepare correct shops.dtd
        /*if ($file == 'shops.dtd') {
            if (!file_exists($path)) {
