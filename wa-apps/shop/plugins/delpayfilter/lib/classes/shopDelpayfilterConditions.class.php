...
class shopDelpayfilterConditions extends shopDelpayfilterData
{
    ...
    private static $type_precedence = array(
        'ucat' => 0, 'user' => 0, 'user_date' => 0, 'user_data' => 0, 'product_stock' => 0, 'product_stock_storefront' => 0, 'user_country' => 0, 'shipping' => 0, 'user_city' => 0,
        'user_auth' => 0, 'all_orders' => 0, 'order_int' => 0, 'coupon' => 0, 'isset_coupon' => 0,
        ...
        'cat' => 1, 'cat_all' => 1, 'set' => 1, 'type' => 1, 'product' => 1, 'feature' => 1, 'services' => 1, 'product_tags' => 1,
        'num' => 2, 'num_prod' => 2, 'num_cat' => 2, 'num_cat_all' => 2, 'num_set' => 2, 'num_type' => 2, 'num_feat' => 2, 'num_items' => 2, 'total' => 2, 'total_with_shipping' => 2,
        'total_without_discount' => 2, 'total_without_discount_shipping' => 2, 'discount' => 2, 'sum' => 2, 'sum_cat' => 2, 'sum_cat_all' => 2,
        'num_all_cat' => 2, 'num_all_tags' => 2, 'num_all_cat_all' => 2, 'num_all_set' => 2, 'num_all_type' => 2, 'sum_feat' => 2, 'total_feat' => 2, 'prod_price' => 2,
        'prod_each_price' => 2, 'shipping_price' => 2
    );
    ...
    private static function initConstants()
    {
        ...
        self::$types = array(
            ...
            'product_stock_storefront' => array(
                _wp('Product stock count'),
                _wp('on '),
                array('type' => 'stocks', 'placeholder' => _wp('all stocks'), 'id' => 'stocks', 'class' => 'stocks-select', 'name' => 'field'),
                self::$optsStocks,
                self::$optsNum,
                _wp('product quantity in the order'),
            ...
            'num_all_tags' => array(_wp('Quantity of all products with tags'), self::$optsEqNe, array('type' => 'tags', 'placeholder' => _wp('Select tags'), 'id' => 'tags', 'name' => 'field'), self::$optsNum2, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 90px'))),
            'num_feat' => array(
            ...
            'total_with_shipping' => array(_wp('Order price with discount + Shipping price'), self::$optsNum, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px')), $currency['sign']),
            'total_without_discount' => array(_wp('Order price without discount'), self::$optsNum, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px')), $currency['sign']),
            'total_without_discount_shipping' => array(_wp('Order price without discount + Shipping price'), self::$optsNum, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px')), $currency['sign']),
            'discount' => array(_wp('Total discount'), self::$optsNum, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px')), $currency['sign']),
            ...
            'cookie' => array('$__COOKIE["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]', self::$optsAll, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px'))),
            'session' => array('$__SESSION["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]', '["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field2', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]', self::$optsAll, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px'))),
            'get' => array('$__GET["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]', self::$optsAll, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px'))),
            'post' => array('$__POST["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]', self::$optsAll, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px'))),
            'not_isset_post' => array(_wp('Not isset') . ' $__POST["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]'),
            'not_isset_get' => array(_wp('Not isset') . ' $__GET["', array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'field', 'params' => array('style' => 'width: 150px; min-width: 150px')), '"]'),
            'storefront' => array(
                _wp('Storefront'),
                self::$optsEqNe,
            ...
            'coupon' => array(_wp('Coupon'), self::$optsEqNe, array('type' => 'input', 'control_type' => waHtmlControl::INPUT, 'name' => 'value', 'params' => array('style' => 'width: 150px; min-width: 150px'))),
            'isset_coupon' => array(self::$optsEqNe, _wp('Isset active coupon')),
        );
    ...
    private static function filter_by_product_stock($items, $params)
    {
        ...
        foreach ($items as $k => $item) {
            ...
            $params['value'] = $params['value'] === 'quantity' ? $item['quantity'] : $params['value'];
    ...
    private static function filter_by_product_stock_storefront($items, $params)
    {
        $params['value'] = 'quantity';
        return self::filter_by_product_stock($items, $params);
    }
    ...
    private static function filter_by_num_prod($items, $params)
    {
        if (!empty($params['field'])) {
            $result_items = self::filter_by_product($items, array('op' => 'eq', 'value' => $params['field']));
            return self::_filter_by_num($result_items, $params['op'], $params['value']) ? $items : [];
        } else {
            foreach ($items as $k => $item) {
    ...
    private static function filter_by_num_all_tags($items, $params)
    {
        if (!empty($params['field'])) {
            $result_items = self::filter_by_product_tags($items, array('op' => $params['op'], 'value' => $params['field']));
            return self::_filter_by_num($result_items, $params['op2'], $params['value']);
        }
        return array();
    }
    ...
    {
        if (!self::execute_operator($params['op'], (new shopDelpayfilterHelper())->getTotalPrice(), $params['value'])) {
            return array();
        }
    ...
    private static function filter_by_total_with_shipping($items, $params)
    {
        // Инициирум расчет цены за доставку
        self::filter_by_shipping_price($items, ['op' => 'eq', 'value' => 0]);
        $total = (new shopDelpayfilterHelper())->getTotalPrice() + waRequest::param('delpayfilter_shipping_price', 0);
    ...
    private static function filter_by_total_without_discount($items, $params)
    {
        if (!self::execute_operator($params['op'], (new shopDelpayfilterHelper())->getTotalPrice(false), $params['value'])) {
            return array();
        }
    ...
    private static function filter_by_total_without_discount_shipping($items, $params)
    {
        // Инициирум расчет цены за доставку
        self::filter_by_shipping_price($items, ['op' => 'eq', 'value' => 0]);
        $total = (new shopDelpayfilterHelper())->getTotalPrice(false) + waRequest::param('delpayfilter_shipping_price', 0);
        if (!self::execute_operator($params['op'], $total, $params['value'])) {
            return array();
        }
    ...
    private static function filter_by_discount($items, $params)
    {
        $discount = (new shopDelpayfilterHelper())->getTotalDiscount();
        if (!self::execute_operator($params['op'], $discount, $params['value'])) {
            return array();
        }
    ...
    private static function _filter_by_user_address($items, $params, $type = 'country')
    {
        ...
        if ($value) {
            ...
            if ($type == 'country') {
                ...
                // Если адреса нет, проверяем наличие плагина SEO регионы
                if (!$cities) {
                    // Список всех плагинов
                    $plugins = wa()->getConfig()->getPlugins();
                    // Проверяем доступность плагина
                    if (class_exists('shopRegionsPlugin') && isset($plugins['regions'])) {
                        $current_city = (new shopRegionsRouting())->getCurrentCity();
                        if ($current_city instanceof shopRegionsCity) {
                            $cities[] = mb_strtolower($current_city->getName(), 'UTF-8');
                        }
                    }
                }
                if ($cities) {
                    ...
                    foreach ($cities as $city) {
                        ...
                        if (self::execute_operator($params['op'], trim($city), $value)) {
                            return $items;
                        }
                    }
                }
        ...
        if (!empty($params['field'])) {
            ...
            if (isset($param[$params['field']])) {
                ...
                if (empty($params['field2'])) {
                    $field_value = $param[$params['field']];
                } elseif (isset($param[$params['field']][$params['field2']])) {
                    $field_value = $param[$params['field']][$params['field2']];
                }
                if ($field_value !== null && self::execute_operator($params['op'], $field_value, $params['value'])) {
                    return $items;
                }
            }
        }
    ...
    {
        if ($params['value']) {
            $storefront = shopDelpayfilterHelper::getDomain();
    ...
    private static function filter_by_shipping_price($items, $params, $return_bool = false, $type = 'shipping')
    {
        ...
        if (!empty($order_params['shipping']['id'])) {
            ...
            $plugin_info = (new shopPluginModel())->getById($shipping_id);
            $plugin = shopShipping::getPlugin($plugin_info['plugin'], $shipping_id);
            $total = (new shopDelpayfilterHelper())->getTotalPrice();
            ...
            if ($rates && !is_string($rates)) {
                ...
                waRequest::setParam('delpayfilter_shipping_price', $rate['rate']);
    ...
    private static function filter_by_coupon($items, $params)
    {
        ...
        $codes = (new shopDelpayfilterData())->getCouponCodes();
        if ($codes) {
    ...
    private static function filter_by_isset_coupon($items, $params)
    {
        $has_coupons = 0;
        // Получаем информацию о купонах
        $codes = (new shopDelpayfilterData())->getCouponCodes();
        if ($codes) {
            ...
            if (self::execute_operator($params['op'], $has_coupons, 1)) {
                return $items;
            }
        }
        return array();
    ...
    private static function filter_by_product_tags($items, $params)
    {
        ...
        $tags = (new shopDelpayfilterData())->getProductTags($product_ids);
