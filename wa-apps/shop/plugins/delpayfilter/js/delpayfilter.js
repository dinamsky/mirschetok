...
$.delpayfilter = {
    ...
    init: function (params) {
        ...
        this.localeStrings = params.localeStrings || {};

        $.ig_locale = $.extend(this.localeStrings, $.ig_locale);
    ...
    load: function (url, callback) {
        ...
        this.random = r;
        var self = this;
        $("#delpayfilter-interactive-block").html($__("Loading...") + '<i class="icon16 loading"></i>');
    ...
    showConditionAction: function (btn) {
        ...
        var select = condBlock.find(".condition-template").chosen({disable_search_threshold: 10, no_results_text: $__("No result text")}).trigger('chosen:open')
    ...
    initTargetChosen: function (select) {
        select.chosen({disable_search_threshold: 10, no_results_text: $__("No result text")}).trigger('chosen:open')
