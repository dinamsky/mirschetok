...
class shopSeoredirectShopUrlTypeModel extends waModel
{
	protected $table = 'shop_seoredirect_shop_url_type';
	protected $cache;
	...
	{
		return new waSerializeCache('url_types', -1, 'shop_seoredirect');
	}
