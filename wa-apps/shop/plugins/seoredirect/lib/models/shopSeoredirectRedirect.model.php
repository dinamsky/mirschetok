...
class shopSeoredirectRedirectModel extends waModel
{
	const GENERAL_DOMAIN = 'general';
	protected $table = 'shop_seoredirect_redirect';
	protected $cache;
	...
	{
		return new waSerializeCache('redirects', -1, 'shop_seoredirect');
	}
	...
	{
		return shopSeoredirectRedirect::type($url);
	}

	public static function isReg($url)
	{
		return shopSeoredirectRedirect::isReg($url);
	}
