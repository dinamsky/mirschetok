...
class shopSeoredirectRedirect
{
	...
	public function getUrlTo()
	{
		...
		if (self::isUrl($url_to) === false)
		{
			...
			$url_to = '//' . str_replace('*', '', $domain) . $url_to;
		}
	...
	public function redirect()
	{
		...
		shopSeoredirectWaResponse::redirect($url_to, $this->getCodeHttp());
	}
	...
	public function setUrl(shopSeoredirectUrl $url)
	{
		$this->url = $url;
