...
class shopSeoredirectShopRouting extends shopSeoredirectRouting
{
	...
	public function getUrlType(&$url_type = null)
	{
		...
		{
			$url_type = shopSeoredirectUrlType::FLAT;
		}
	...
	{
		if ($url_type == shopSeoredirectUrlType::FLAT || $url_type == shopSeoredirectUrlType::MIXED)
		{
	...
	{
		if ($url_type == shopSeoredirectUrlType::FLAT)
		{
