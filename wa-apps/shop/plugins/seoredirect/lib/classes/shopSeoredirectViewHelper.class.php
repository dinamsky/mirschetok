...
class shopSeoredirectViewHelper
{
	/**
	...
	public static function createErrorNode($error_code = null)
	{
		...
		if (!$has_redirect)
		{
			$errors_storage = new shopSeoredirectErrorStorage();
	...
	public static function getNameByType($type) {
		$type_name = array('Категория', 'Товар', 'Страница товара', 'Информационная страница', 'SEO filter', 'Отзывы', 'Брэнды');
	...
	public static function getParentBackendUrlByData($autoredirect)
	{
		...
		switch ($autoredirect['type']) {
			case shopSeoredirectType::CATEGORY:
				break;
			case shopSeoredirectType::PRODUCT:
				$data['type'] = shopSeoredirectType::CATEGORY;
				break;
			case shopSeoredirectType::PRODUCT_PAGE:
				$data['type'] = shopSeoredirectType::PRODUCT;
				break;
			case shopSeoredirectType::PAGE:
				break;
			case shopSeoredirectType::SEOFILTER:
			...
			case shopSeoredirectType::PRODUCT_REVIEWS:
				...
				break;
			case shopSeoredirectType::PRODUCTBRANDS_CATEGORY:
				$data['type'] = shopSeoredirectType::PRODUCTBRANDS;
				break;
		}
