...
class shopSeoredirectCatalogreviewsPluginHelper
{
	...
	protected function __construct()
	{
		...
		$this->seofilter_plugin_helper = shopSeoredirectSeofilterPluginHelper::getInstance();
		$this->seofilter_filter_storage = $this->seofilter_plugin_helper->getFilterStorage();
	}

	/**
	 * @return shopSeoredirectCatalogreviewsPluginHelper
	 */
