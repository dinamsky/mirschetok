var QuickorderPlugin = (function ($) {
    ...
    QuickorderPlugin.prototype.initSave = function () {
        ...
        function getData() {
            ...
            $('#f-quickorder-css-template').val(wa_editor.getValue());

            var skuStocksTmpl = that.$form.find('.f-sku-stocks-tmpl');
            if (skuStocksTmpl.data('codemirror')) {
                skuStocksTmpl.val(skuStocksTmpl.data('codemirror').getValue());
            }
