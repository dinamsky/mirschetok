...
class shopQuickorderPluginCart
{
    ...
    private function processProduct($product, $item)
    {
        ...
        $products = (new shopQuickorderPluginProductData())->prepareProducts(array($product), false, true);
    ...
    public function getItems()
    {
        ...
        if ($this->type == 'product') {
            $items = $this->getItemsForProduct();
        } else {
            $items = $this->getItemsForCart();
        }
     ...
     * @throws Exception
     */
    public function getDiscount($order = array())
    {
    ...
    private function setContact($fields)
    {
        if ($fields) {
            ...
            if ($shipping_id) {
                ...
                elseif (isset($address_field['address.shipping'])) {
