...
class shopQuickorderPluginSettingsLoadStorefrontAction extends waViewAction
{
    public function execute()
    {
        ...
        // Шаблон всплывающего окна артикулов. Остатки
        $sku_variants_stocks_tmpl = !isset($settings['sku_variants_stocks_tmpl']) ? file_get_contents(wa()->getAppPath('plugins/quickorder/templates/actions/frontend/include.sku_variants.stocks.html', 'shop')) : $settings['sku_variants_stocks_tmpl'];
        ...
        $this->view->assign('sku_variants_stocks_tmpl', $sku_variants_stocks_tmpl);
