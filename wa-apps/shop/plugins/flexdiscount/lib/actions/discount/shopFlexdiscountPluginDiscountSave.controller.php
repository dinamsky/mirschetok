    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            foreach ($float_params as $p) {
                if (!empty($params[$p])) {
                    $params[$p] = shopFlexdiscountHelper::floatVal($params[$p]);
                }
            }
            if (!empty($params['maximum']['value'])) {
                $params['maximum']['value'] = shopFlexdiscountHelper::floatVal($params['maximum']['value']);
            }
            if (!empty($params['limit']['value'])) {
                $params['limit']['value'] = shopFlexdiscountHelper::floatVal($params['limit']['value']);
            }
