$.flexdiscount_conditions = {
    ...
    init: function (options) {
        ...
        this.types = {
            ...
            session: ['$__SESSION["', {type: 'Input', name: 'field', width: '150px'}, '"]', this.optsAll, {type: 'Input', name: 'value', width: '150px'}],
            ...
            server: ['$__SERVER["', {type: 'Input', name: 'field', width: '150px'}, '"]', this.optsAll, {type: 'Input', name: 'value', width: '150px'}],
    ...
    afterLoadInit: function () {
        ...
        $(".feature-select, .storefront-domain, .stocks-select").each(function () {
            $(this).change();
        });
    ...
    reinitChosen: function () {
        ...
        $("#flexdiscount-save-form .targets select").not(".hidden").each(function () {
            var select = $(this);
