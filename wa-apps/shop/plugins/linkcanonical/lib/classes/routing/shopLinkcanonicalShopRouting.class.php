...
class shopLinkcanonicalShopRouting extends shopLinkcanonicalRouting
{
	public function __construct()
	{
		$shop_config_path = wa()->getAppPath('lib/config/routing.php', 'shop');
		parent::__construct($shop_config_path);
	}
	...
	public function getUrlType(&$url_type = null)
	{
		...
		{
			$url_type = shopLinkcanonicalUrlType::FLAT;
		}
	...
	{
		if ($url_type == shopLinkcanonicalUrlType::FLAT || $url_type == shopLinkcanonicalUrlType::MIXED)
		{
	...
	{
		if ($url_type == shopLinkcanonicalUrlType::FLAT)
		{
