<?php /* Smarty version Smarty-3.1.14, created on 2020-12-21 19:32:40
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-system/login/templates/login/backend/field.html" */ ?>
<?php /*%%SmartyHeaderCode:8728990225fe0ce287d9868-73325582%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a120e4d91a2df2ab61e2daf011cf34dbdc97b55' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-system/login/templates/login/backend/field.html',
      1 => 1547474149,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8728990225fe0ce287d9868-73325582',
  'function' => 
  array (
    'render_errors' => 
    array (
  ...
  'unifunc' => 'content_5fe0ce288d5565_40351825',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe0ce288d5565_40351825')) {function content_5fe0ce288d5565_40351825($_smarty_tpl) {?>
...
" class="wa-request-onetime-password-link">Re-send</a><i class="icon16 loading wa-request-onetime-password-link-loading" style="margin-top: 0px; margin-left: 2px; display: none"></i></div><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php $_smarty_tpl->tpl_vars['_html'] = new Smarty_variable(($_smarty_tpl->tpl_vars['_html']->value).($_smarty_tpl->tpl_vars['_link_html_password']->value), null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['_field_id']->value==='login'){?><?php $_smarty_tpl->_capture_stack[0][] = array('default', "_link_html_login", null); ob_start(); ?><a class="wa-change-login-link" href="javascript:void(0);" style="display: none;">Change</a><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
