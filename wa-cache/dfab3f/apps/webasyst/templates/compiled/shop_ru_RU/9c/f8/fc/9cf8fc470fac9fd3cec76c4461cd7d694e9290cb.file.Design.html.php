<?php /* Smarty version Smarty-3.1.14, created on 2020-12-20 22:51:33
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-system/design/templates/Design.html" */ ?>
<?php /*%%SmartyHeaderCode:16660212915fdfab459fdc71-90319038%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9cf8fc470fac9fd3cec76c4461cd7d694e9290cb' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-system/design/templates/Design.html',
      1 => 1593073650,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16660212915fdfab459fdc71-90319038',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fdfab45ba5631_50584268',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fdfab45ba5631_50584268')) {function content_5fdfab45ba5631_50584268($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/u1240732/data/www/mirschetok.ru/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
                ...
                <div class="dialog-content">
                    <div class="dialog-content-indent">
                        ...
                        <?php if (waRequest::isHttps()){?>
                            <p>Предварительный просмотр темы дизайна не будет работать на доменном имени <strong id="wa-preview-domain"></strong>, если оно недоступно по протоколу HTTPS. Если это так, то для предпросмотра темы дизайна либо установите SSL-сертификат для этого домена, либо войдите в свой Webasyst на этом домене.</p>
                        <?php }?>
                    </div>
                </div>
...
";
        ...
        $('#wa-design-menu,#wa-design-container').on('click', ".wa-theme-preview", function (e) {
            ...
            if (!tmp_params['route']) {
                ...
                var $dialog = $("#wa-design-preview"),
                    $_anchor = $("<div />", { class: "js-place-for-dialog" }).hide().insertBefore($dialog);
