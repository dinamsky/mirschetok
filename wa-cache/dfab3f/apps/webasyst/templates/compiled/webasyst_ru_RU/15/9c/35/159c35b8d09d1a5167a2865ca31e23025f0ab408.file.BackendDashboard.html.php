<?php /* Smarty version Smarty-3.1.14, created on 2020-12-21 13:00:21
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/backend/BackendDashboard.html" */ ?>
<?php /*%%SmartyHeaderCode:6301831555fe07235db7d26-31355206%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '159c35b8d09d1a5167a2865ca31e23025f0ab408' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/backend/BackendDashboard.html',
      1 => 1589293842,
      2 => 'file',
    ),
    '7c3bf21630018525aa19f1f0294dbd8d1ecde4d6' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/dashboard/DashboardAnnouncement.html',
      1 => 1540900318,
      2 => 'file',
    ),
    ...
    '28f299d83067abdbbe8c04a1dedc728919280f3b' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/dashboard/DashboardWidget.html',
      1 => 1540900318,
      2 => 'file',
    ),
    '103222da9fdd70a639f920d43490e1654fc657eb' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/dashboard/DashboardWidgets.html',
      1 => 1589293842,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6301831555fe07235db7d26-31355206',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe0723605ced9_69646733',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe0723605ced9_69646733')) {function content_5fe0723605ced9_69646733($_smarty_tpl) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../dashboard/DashboardAnnouncement.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '6301831555fe07235db7d26-31355206');
content_5fe07235dd7458_11066892($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../dashboard/DashboardActivity.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('datetime_group'=>''), 0, '6301831555fe07235db7d26-31355206');
content_5fe07235e4ebe9_40715075($_smarty_tpl);
            ...
            <div class="d-first-notice-wrapper" id="d-first-notice-wrapper" data-show-notice="<?php if (!empty($_smarty_tpl->tpl_vars['show_tutorial']->value)){?>true<?php }else{ ?>false<?php }?>">
                <div class="d-first-notice-block">
                    ...
                    <div class="notice-content">
                        <h3>Добро пожаловать на вашу панель управления Webasyst!</h3>
                        <p>Настройте вашу панель управления с помощью ссылки выше. Располагайте виджеты так, как удобно именно вам. Набор виджетов на панели управления у каждого пользователя Webasyst индивидуален.</p>
                    </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("../dashboard/DashboardWidgets.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '6301831555fe07235db7d26-31355206');
content_5fe07235ec8bf0_31352743($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../dashboard/DashboardWidgets.html" */?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['is_admin']->value){?>
        ...
        <select class="d-dashboards-select" id="d-dashboards-select" name="">
            <option value="default_dashboard" selected>Моя панель управления</option>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['d']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
                ...
                <?php } ?>
                <option value="new_dashboard">Новая панель Webasyst TV...</option>
            </optgroup>
        </select>
                ...
                <div class="dialog-window">
                    <div class="dialog-content">
                        <div class="dialog-content-indent">
                            ...
                            <p class="hint">Панель управления Webasyst TV открывается по уникальной приватной ссылке в любом современном браузере и предназначена для трансляции на телевизоры 4K или Full HD.</p>
                        </div>
                    </div>
    ...
    <?php }?>
</div><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2020-12-21 13:00:21
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/dashboard/DashboardAnnouncement.html" */ ?>
<?php if ($_valid && !is_callable('content_5fe07235dd7458_11066892')) {function content_5fe07235dd7458_11066892($_smarty_tpl) {?><div class="d-notification-wrapper <?php if (empty($_smarty_tpl->tpl_vars['show_tutorial']->value)){?>is-shown<?php }?>" id="d-notification-wrapper">
...
<?php if ($_valid && !is_callable('content_5fe07235e4ebe9_40715075')) {function content_5fe07235e4ebe9_40715075($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['_group'] = new Smarty_variable(ifset($_smarty_tpl->tpl_vars['datetime_group']->value,''), null, 0);?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2020-12-21 13:00:21
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/dashboard/DashboardWidgets.html" */ ?>
<?php if ($_valid && !is_callable('content_5fe07235ec8bf0_31352743')) {function content_5fe07235ec8bf0_31352743($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_join')) include '/var/www/u1240732/data/www/mirschetok.ru/wa-system/vendors/smarty-plugins/modifier.join.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./DashboardWidget.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '6301831555fe07235db7d26-31355206');
content_5fe07235ede350_89116060($_smarty_tpl);
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php } ?></div><?php } ?><div class="widget-group-wrapper"></div></div><div class="empty-widgets-wrapper <?php if (empty($_smarty_tpl->tpl_vars['widgets']->value)){?>is-shown<?php }?>" id="empty-widgets-wrapper">Ваша панель управления пуста. Добавьте виджеты на панель, щелкнув по ссылке «Настроить виджеты» в левом верхнем углу.</div><div class="loading-ornament-wrapper"><div class="image-wrapper"></div></div></div><script src="<?php echo $_smarty_tpl->tpl_vars['wa_url']->value;?>
...
</section><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2020-12-21 13:00:21
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-system/webasyst/templates/actions/dashboard/DashboardWidget.html" */ ?>
<?php if ($_valid && !is_callable('content_5fe07235ede350_89116060')) {function content_5fe07235ede350_89116060($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['_widget_width'] = new Smarty_variable($_smarty_tpl->tpl_vars['w']->value['size'][0], null, 0);?><?php $_smarty_tpl->tpl_vars['_widget_height'] = new Smarty_variable($_smarty_tpl->tpl_vars['w']->value['size'][1], null, 0);?><?php $_smarty_tpl->tpl_vars['is_small'] = new Smarty_variable((($_smarty_tpl->tpl_vars['_widget_width']->value==1)&&($_smarty_tpl->tpl_vars['_widget_height']->value==1)), null, 0);?><?php $_smarty_tpl->tpl_vars['is_medium'] = new Smarty_variable((($_smarty_tpl->tpl_vars['_widget_width']->value==2)&&($_smarty_tpl->tpl_vars['_widget_height']->value==1)), null, 0);?><?php $_smarty_tpl->tpl_vars['is_big'] = new Smarty_variable((($_smarty_tpl->tpl_vars['_widget_width']->value==2)&&($_smarty_tpl->tpl_vars['_widget_height']->value==2)), null, 0);?><?php ob_start();?><?php echo rand(0,9);?>
