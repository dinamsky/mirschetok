<?php /* Smarty version Smarty-3.1.14, created on 2020-12-22 00:28:45
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-apps/shop/templates/actions/products/Products.html" */ ?>
<?php /*%%SmartyHeaderCode:18446614625fe1138de258a9-66292836%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55c90a624ae9e63ac07d6ff9f605df2ddf12a479' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-apps/shop/templates/actions/products/Products.html',
      1 => 1576582843,
      2 => 'file',
    ),
    'ee506547f496733a3d368825767425895628b52f' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-apps/shop/templates/actions/dialog/DialogProductListEmbed.html',
      1 => 1591777042,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18446614625fe1138de258a9-66292836',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe1138e26b2a6_84920967',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe1138e26b2a6_84920967')) {function content_5fe1138e26b2a6_84920967($_smarty_tpl) {?><?php if (!is_callable('smarty_function_wa_pagination')) include '/var/www/u1240732/data/www/mirschetok.ru/wa-system/vendors/smarty-plugins/function.wa_pagination.php';
                ...
                <li class="s-inline-mixed-string float-right" id="s-sort-control">
                    <ul class="menu-v dropdown">
                        <li id="js-sort-dropdown">Сортировка:
                            <?php $_smarty_tpl->tpl_vars['with_icon'] = new Smarty_variable(true, null, 0);?><a href="javascript:void(0);" class="inline-link<?php if ($_smarty_tpl->tpl_vars['default_sort']->value!=$_smarty_tpl->tpl_vars['sort']->value||$_smarty_tpl->tpl_vars['default_order']->value!=$_smarty_tpl->tpl_vars['order']->value){?> highlighted<?php }?>"><b><i><?php if ($_smarty_tpl->tpl_vars['sort']->value=='name'){?>название товара<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='price'){?>цена<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='sku'){?>название артикула<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='compare_price'){?>зачеркнутая цена<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='purchase_price'){?>закупочная цена<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='count'){?>на складе<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='rating'){?>рейтинг<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='create_datetime'){?>добавлен<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='total_sales'){?>продажи<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='stock_worth'){?>стоимость активов<?php }elseif($_smarty_tpl->tpl_vars['sort']->value=='sort'){?>вручную<?php $_smarty_tpl->tpl_vars['with_icon'] = new Smarty_variable(false, null, 0);?><?php }else{ ?><?php if (!empty($_smarty_tpl->tpl_vars['additional_columns']->value[$_smarty_tpl->tpl_vars['sort']->value])){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['additional_columns']->value[$_smarty_tpl->tpl_vars['sort']->value]['name'], ENT_QUOTES, 'UTF-8', true);?>
...
&<?php }?>view=<?php echo $_smarty_tpl->tpl_vars['view']->value;?>
&sort=price&order=<?php if ($_smarty_tpl->tpl_vars['order']->value=='asc'&&$_smarty_tpl->tpl_vars['sort']->value=='price'){?>desc<?php }else{ ?>asc<?php }?>"class="no-underline <?php if ($_smarty_tpl->tpl_vars['sort']->value=='price'){?>selected<?php }?>">цена</a><?php if ($_smarty_tpl->tpl_vars['sort']->value=='price'){?><i class="icon10 <?php if ($_smarty_tpl->tpl_vars['order']->value=='asc'){?>uarr-tiny<?php }else{ ?>darr-tiny<?php }?>"></i><?php }?></li><li class="sort"><a href="#/products/<?php if ($_smarty_tpl->tpl_vars['collection_param']->value){?><?php echo $_smarty_tpl->tpl_vars['collection_param']->value;?>
&<?php }?>view=<?php echo $_smarty_tpl->tpl_vars['view']->value;?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../dialog/DialogProductListEmbed.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '18446614625fe1138de258a9-66292836');
content_5fe1138e1fd040_41862346($_smarty_tpl);
...
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2020-12-22 00:28:46
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-apps/shop/templates/actions/dialog/DialogProductListEmbed.html" */ ?>
<?php if ($_valid && !is_callable('content_5fe1138e1fd040_41862346')) {function content_5fe1138e1fd040_41862346($_smarty_tpl) {?><div  id="s-product-list-embed-dialog" class="dialog">
    <div class="dialog-background"></div>
    <div class="dialog-window">
        <div class="dialog-content">
