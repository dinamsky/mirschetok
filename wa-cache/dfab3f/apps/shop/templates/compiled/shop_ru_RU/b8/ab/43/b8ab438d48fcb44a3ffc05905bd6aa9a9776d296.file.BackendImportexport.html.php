<?php /* Smarty version Smarty-3.1.14, created on 2020-12-22 19:03:56
         compiled from "/var/www/u1240732/data/www/mirschetok.ru/wa-apps/shop/templates/actions/backend/BackendImportexport.html" */ ?>
<?php /*%%SmartyHeaderCode:10743402795fe218eca1c3a3-98242189%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8ab438d48fcb44a3ffc05905bd6aa9a9776d296' => 
    array (
      0 => '/var/www/u1240732/data/www/mirschetok.ru/wa-apps/shop/templates/actions/backend/BackendImportexport.html',
      1 => 1569937939,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10743402795fe218eca1c3a3-98242189',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe218ecb52a39_97250094',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe218ecb52a39_97250094')) {function content_5fe218ecb52a39_97250094($_smarty_tpl) {?><?php if (!is_callable('smarty_block_wa_js')) include '/var/www/u1240732/data/www/mirschetok.ru/wa-system/vendors/smarty-plugins/block.wa_js.php';
...
$_smarty_tpl->tpl_vars['plugin_names']->value[$_smarty_tpl->tpl_vars['info']->value['id']] = htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['info']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['info']->value['id'] : $tmp), ENT_QUOTES, 'UTF-8', true);?>
                <li>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['info']->value['img'], ENT_QUOTES, 'UTF-8', true);?>
');"></i><?php }?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['info']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['info']->value['id'] : $tmp), ENT_QUOTES, 'UTF-8', true);?>

                        <span class="hint"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['info']->value['description'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</span>
                    </a>
                </li>
                <?php } ?>
